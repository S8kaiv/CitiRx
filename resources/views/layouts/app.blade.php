...
<body class="h-full font-sans text-slate-900 antialiased selection:bg-primary-tint selection:text-primary relative">
    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        @if (!$isFocusMode)
            ...
            <nav class="fixed bottom-0 inset-x-0 z-40 flex md:hidden items-center justify-around border-t-2 border-slate-200 bg-white/95 backdrop-blur-md py-2 px-1 shadow-lg font-display text-[9px] font-bold">
                ...
                @if ($authUser?->role === 'student')
                    ...
                    {{-- 4. Vault (Includes Bookmarks tab inside) --}}
